...
* 📊 **Full Transfer History Log** — We've added an interactive, full-page transfer history log so you can filter, view, and export records of your recent uploads.
* 🏷️ **Labels in Context Menu** — Right-click to send directly to distinct categories! You can now configure labels that populate seamlessly in your right-click "Send with Label" submenu.
* 🎨 **Dark/Light Themes** — A beautiful custom UI system that naturally follows your OS preference.
...
* 🔧 **Multi-Server Profiles** — Add multiple servers (host, port, credentials, labels, directories) and jump between them.
* 🚀 **Optimized Performance** — Smart DOM scanning for minimal CPU usage with zero tracking.
* 📡 **RSS feed support** (for clients that allow feed imports).
* 🍞 **Interactive notifications** for success and error events (badge color natively shifts green or red based on live statuses!).
* 🌐 **Global Language Support** — Available in 15+ local languages!
...
* ✅ Full localization and future-ready responsive design.
...
> **Detect the link. Send the torrent. Done.**
